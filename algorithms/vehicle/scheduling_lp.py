...
def minimize_cost(solver,opt_step,opt_horizon,ecap,tarsoc,minsoc,maxsoc,crtsoc,crttime,inisoc,p_ch,p_ds,dps):
    """
    ...
    #OBJECTIVE FUNCTION
    def obj_rule(model):  
        return sum(model.p[t]*model.price[t] for t in opt_horizon[:-1])*opt_step/3600
...
if __name__ == '__main__':
    ...
    p1, s1 = minimize_cost(solver, step, horizon, ecap, tarsoc, minsoc, maxsoc, crtsoc, crttime, inisoc, pch, pds, dps1)
    p2, s2 = minimize_cost(solver, step, horizon, ecap, tarsoc, minsoc, maxsoc, crtsoc, crttime, inisoc, pch, pds, dps2)
    p3, s3 = minimize_cost(solver, step, horizon, ecap, tarsoc, minsoc, maxsoc, crtsoc, crttime, inisoc, pch, pds, dps3)
