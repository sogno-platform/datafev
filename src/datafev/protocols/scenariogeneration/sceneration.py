...
def generate_fleet_data_independent_times(arr_soc_dict, dep_soc_dict, ev_dict, number_of_evs_per_day,
                        ...
                        diff_arr_dep_in_min=0, arr_times_dict=None, dep_times_dict=None, dep_day_prob_distribution=None
                        ):
    """
    ...
    for day, pre_assingment in pre_arr_assignment.items():
        for arr_time_lowerb in pre_assingment:
            ...
            while True:
                time_lst = ut.generate_time_list(arr_datetime_lowerb, arr_datetime_upperb, timedelta_in_min, day)
    ...
    for ev_id, arrival_dt in arr_assignment.items():
        ...
        if arrival_dt.weekday() <= 4:
            while True:
                ...
                time_lst = ut.generate_time_list(dep_datetime_lowerb, dep_datetime_upperb, timedelta_in_min, assigned_date)
    ...
    for ev_id, row in gen_ev_df.iterrows():
        ...
        ev_arr_soc_possibilities = list(ut.drange(ev_arr_soc_lowerb, arr_soc_bounds_dict[ev_arr_soc_lowerb], '0.001'))
        ...
        while True:
            ...
            if ev_dep_soc_lowerb > ev_arr_soc:
                ev_dep_soc_possibilities = list(
                    ut.drange(ev_dep_soc_lowerb, dep_soc_bounds_dict[ev_dep_soc_lowerb], '0.001'))
...
def generate_fleet_data_dependent_times(arr_soc_dict, dep_soc_dict, ev_dict, number_of_evs,
                        startdate=dt.date(2020, 5, 17), enddate=dt.date(2020, 5, 19), timedelta_in_min=15,
                        diff_arr_dep_in_min=0, times_dict=None, arr_dep_times_dict=None
                        ):
    """
    ...
    for time_pair_id in pre_assignment:
        ...
        # Arrival time        
        arr_time_lst = ut.generate_datetime_list(arr_datetime_lowerb, arr_datetime_upperb, timedelta_in_min)
        ...
        while True:
            ...
            if arrival_possibility < endtime - timedelta(minutes=timedelta_in_min):
                ...
                ev_arr_time_lowerbs[ev_id] = arr_datetime_upperb
                # Departure time
                dep_time_lst = ut.generate_datetime_list(dep_datetime_lowerb, dep_datetime_upperb, timedelta_in_min)
            while True:
