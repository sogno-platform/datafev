...
def main():
    ...
    times_dict, arr_dep_times_dict, arr_soc_dict, dep_soc_dict, ev_dict = \
        ut.excel_to_sceneration_input_dependent_times(file_path=r'C:\Users\aytugy\Desktop\workspace\datafev\src\datafev\tutorials\scenariogeneration\input_generator.xlsx')
    ...
    ev_df.to_excel(r'C:\Users\aytugy\Desktop\workspace\datafev\src\datafev\outputs\output_generator_dependent_times.xlsx')
    
    ut.output_to_sim_input(ev_df, r'C:\Users\aytugy\Desktop\workspace\datafev\src\datafev\outputs\input_simulator_dependent_times.xlsx')
