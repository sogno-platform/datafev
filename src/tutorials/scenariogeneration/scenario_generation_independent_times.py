...
def main():
    ...
    arr_times_dict, dep_times_dict, arr_soc_dict, dep_soc_dict, ev_dict = \
        ut.excel_to_sceneration_input_independent_times(file_path=r'C:\Users\aytugy\Desktop\workspace\datafev\src\tutorials\scenariogeneration\input_generator.xlsx')
    ...
    ut.visualize_statistical_time_generation(r'C:\Users\aytugy\Desktop\workspace\datafev\src\outputs', ev_df, timedelta_in_min=15)
    ...
    ev_df.to_excel(r'C:\Users\aytugy\Desktop\workspace\datafev\src\outputs\output_generator_independent_times.xlsx')
    
    ut.output_to_sim_input(ev_df, r'C:\Users\aytugy\Desktop\workspace\datafev\src\outputs\input_simulator_independent_times.xlsx')
