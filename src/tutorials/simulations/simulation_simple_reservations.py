...
from protocols.simplereservation.reservation import *
from protocols.simplereservation.arrival import *
from protocols.departure import *
from protocols.chargingcontrol.decentralized_llf import charging_protocol
...
arr_del={"cluster1":timedelta(seconds=0),"cluster2":timedelta(seconds=0),"cluster3":timedelta(seconds=0)}
dep_del={"cluster1":timedelta(seconds=0),"cluster2":timedelta(seconds=0),"cluster3":timedelta(seconds=0)}
