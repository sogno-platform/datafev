...
def main():
    ...
    arr_times_dict, dep_times_dict, arr_soc_dict, dep_soc_dict, ev_dict = \
        ut.excel_to_sceneration_input_independent_times(file_path=r'C:\Users\aytugy\Desktop\workspace\charger-clusters\tutorials\scenariogeneration\input_generator.xlsx')
